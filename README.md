...
[OpenWebRuntime](https://github.com/TangramDev/OpenWebRunTime) can work synchronously with the <i>Latest Beta Version Chromium Project</i> Source Code, to do this, you need to refer to the 
<div align=center>
...
About <i>[GetBranch.Bat](https://github.com/TangramDev/WebRT_Chromium_Beta/blob/main/ChromiumSRC/getbranch.bat)</i>
...
About <i>[GetWebRTbranch.Bat](https://github.com/TangramDev/WebRT_Chromium_Beta/blob/main/ChromiumSRC/getWebRTbranch.bat)</i>
...
<div align=left>If you have successfully fetched the source code of the Chromium Project, assuming that the path of the folder where your source code is located is "d:\webrt\m108", we first need to create a "Base branch", you need to Give this branch an appropriate name, eg "Base".</div></p>
...
Here, "<ins>108.0.5359.a</ins>" is the Tag value contained in <i>[ChromiumVer.txt](https://github.com/TangramDev/WebRT_Chromium_Beta/blob/main/ChromiumVer.txt)</i>, and "Base" is the branch name of "Base Branch"</p>
